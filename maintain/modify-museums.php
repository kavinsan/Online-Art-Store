...
<div class="tablediv">
  ...
  <form class="form2" name="form2" action="" method="post">
    <table>
      <tr>
        <td>Enter museum ID to delete</td>
  ...
  <form class="form3" name="form3" action="" method="post">
    <table>
      <tr>
        <td>Enter museum ID to update</td>
        <td><input type="text" name="tupdate1"></td>
      </tr>
      <tr>
        <td>Enter value to update in that museum database</td>
  ...
  {
mysqli_query($dbcon,"insert into museums values('$_POST[t1]','$_POST[t2]','$_POST[t3]','$_POST[t4]','$_POST[t5]','$_POST[t6]','$_POST[t7]','$_POST[t8]','$_POST[t9]', NULL)");
  }
  if (isset($_POST["submit2"]))
  {
    if(is_numeric($_POST[tdelete])){
      mysqli_query($dbcon,"delete from museums where museum_id='$_POST[tdelete]'");
    }
    else{
      echo "<script>
  ...
  {
    mysqli_query($dbcon,"update museums set $_POST[tupdate2]='$_POST[tupdate3]' where museum_id='$_POST[tupdate1]'");
  }
   ?>
   <li><a class"link" href="get-info-museums.php"> CLICK HERE TO SEE THE TABLE FOR DATA </a></li>
</body>
</html>
